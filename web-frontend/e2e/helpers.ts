    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        links: {
          ...
          cancellation: `/optimize/${jobId}/cancel`,
          early_completion: `/optimize/${jobId}/finish-now`,
          schedule: null,
        },
      }),
    });
  ...
  await page.route(`http://localhost:8000/optimize/${jobId}`, async route => {
    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        queue_position: null,
        result: {
          outcome: xlsxReady ? 'optimal' : 'infeasible',
          score: xlsxReady ? score : null,
        ...
        links: {
          ...
          cancellation: `/optimize/${jobId}/cancel`,
          early_completion: `/optimize/${jobId}/finish-now`,
          schedule: xlsxReady ? `/optimize/${jobId}/xlsx` : null,
        },
      }),
    });
  });
