...
import { hasSaveAndLoadEditingWarningActive } from '@/utils/unsavedEditingState';
...
describe('SaveAndLoadPage', () => {
  ...
  it('marks the YAML editor as dirty while editing and clears it on cancel', async () => {
    ...
    await user.click(screen.getByRole('button', { name: /edit yaml/i }));
    expect(hasSaveAndLoadEditingWarningActive()).toBe(true);

    await user.click(screen.getByRole('button', { name: /cancel/i }));
    expect(hasSaveAndLoadEditingWarningActive()).toBe(false);
  });
