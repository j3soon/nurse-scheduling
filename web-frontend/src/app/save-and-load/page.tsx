...
export default function SaveAndLoadPage() {
  ...
  const currentAppVersion = process.env.NEXT_PUBLIC_APP_VERSION || 'unknown';
  ...
  // Add app version to the exported state
  const exportState = {
  ...
  const currentYaml = new CustomDump(exportState, {
    indent: 2,
    lineWidth: 120,
    noRefs: true
  }).represent().trim() + '\n';
  ...
  const getVersionWarning = (parsedData: unknown): string | null => {
    ...
    if (!fileVersion) {
      return `The loaded file does not contain app version information. It may have been created with an older version of the application. Current app version: ${currentAppVersion}`;
    }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 bg-amber-50 border border-amber-200 rounded-lg p-4">
        ...
        <div className="space-y-2 text-sm text-amber-700">
          <p>
            The automated scheduling UI feature is currently under development. For now, please download the YAML file and use the Python CLI tool to generate schedules.
          </p>
          <p>
