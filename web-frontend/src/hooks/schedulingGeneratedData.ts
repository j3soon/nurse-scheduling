...
export function addAutoGeneratedToState(state: SchedulingState): SchedulingState {
  ...
  const normalizePersonHistory = (person: Item): Item => ({
    ...person,
  ...
  return {
    ...
    people: {
      items: [
        ...filteredState.people.items.map(normalizePersonHistory),
        ..._generateAutoGeneratedItems(DataType.PEOPLE).map(normalizePersonHistory),
      ],
