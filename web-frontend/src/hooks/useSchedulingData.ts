...
import { _generateDateItems, addAutoGeneratedToState, applyEntityDefaults, filterAutoGeneratedState, replaceDateGroups } from './schedulingGeneratedData';
...
export function useSchedulingDataInternal() {
  ...
  const loadFromYaml = (yamlData: unknown) => {
    ...
    const newState: SchedulingState = addAutoGeneratedToState(applyEntityDefaults({
